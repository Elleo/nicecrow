...
class _TimelineState extends State<Timeline> {
  ...
  bool hasAudio(api.Status status) {
    for (var media in status.reblog != null
        ? status.reblog!.mediaAttachments
        : status.mediaAttachments) {
      if (media.type == api.MediaAttachmentType.audio) {
        return true;
      }
    }
    return false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: widget.statuses.isEmpty
          ...
          : ListView.builder(
              itemBuilder: (c, i) => hasAudio(widget.statuses[i])
                  ? Card(
                                  ...
                                  for (var media
                                    ...
                                    Padding(
                                        ...
                                        child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(5),
                                            child: media.type == api.MediaAttachmentType.audio
                                                ? SiriWaveform.ios9(
                                                    controller:
